...
$server->register('edit_question', array('question_id'=>'xsd:integer','question_video_id'=>'xsd:integer','question_content'=>'xsd:string','question_answer_a'=>'xsd:string','question_answer_b'=>'xsd:string','question_answer_c'=>'xsd:string','question_answer_d'=>'xsd:string','question_correct'=>'xsd:integer','question_time'=>'xsd:integer'), array('outcome'=>'xsd:string'), serverURL);
...
function edit_question($int1,$int2,$str1,$str2,$str3,$str4,$str5,$int3,$int4)
{
	return	new soapval('return','xsd:string',editQuestion($int1,$int2,$str1,$str2,$str3,$str4,$str5,$int3,$int4));
}
